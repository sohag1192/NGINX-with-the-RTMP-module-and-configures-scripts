...
echo "📝 Writing nginx.conf (RTMP + HLS + HTTP 8080)..."
...
echo "🌐 HLS Playback URLs (Port 8080):"
echo "  - http://your-server-ip:8080/live/stream.m3u8"
echo "  - http://your-server-ip:8080/hls/stream.m3u8"