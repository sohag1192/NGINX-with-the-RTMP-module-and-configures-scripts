...
# Description: Installs NGINX with RTMP + HLS + Stats Monitoring on Ubuntu 22.04
...
echo "📝 Writing nginx.conf with RTMP + HLS + Stats config..."
...
echo "📊 RTMP Stats Page: http://your-server-ip:8080/stat"
